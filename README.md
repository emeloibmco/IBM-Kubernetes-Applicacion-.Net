...
Para este caso, se cuenta con 3 archivos de extención ```.yaml```, que puede encontrar en la carpeta ```SQL Server - Despliegue en Kubernetes```. La explicación de cada archivo se presenta a continuación:
